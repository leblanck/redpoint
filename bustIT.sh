...
caskInstaller() {
  ...
  declare -a casks=("spectacle" "wireshark" "font-hack" "clipy" "atom" "spotify" "slack" "github" "iterm2" "zeplin" "dozer" "figma" "messenger" "itsycal" "dropbox" "sketch" "visual-studio-code" "xnviewmp" "fliqlo")
  atomTrigger="atom"
